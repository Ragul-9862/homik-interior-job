                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img style="width: 50px; height:50px" src="<?php echo $row['image_default']; ?>"> </td>
                                                            <td><img style="width: 50px; height:50px" src="<?php echo $row['image_hover']; ?>"> </td>


                                                            <td>

                                                                <a href="edit_product.php?catid=<?php echo $row['id']; ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="icon-pencil"></i></a>
                                                                <a href="manage_product.php?del=<?php echo ($row['id']); ?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');">
